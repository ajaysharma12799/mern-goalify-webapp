    ...
    return (
        <form>
            <div className='my-3 flex flex-col items-start w-full'>
                ...
                <input type='text' id='username' className='border-2 outline-0 py-3 px-2 rounded-md w-full my-1' />
            </div>
            <div className='my-3 flex flex-col items-start w-full'>
            ...
            <div className='my-3'>
                <button className='bg-blue-500 w-full py-3 text-center rounded-md text-white' type='submit'>Signup</button>
            </div>
        </form>
    )
}
